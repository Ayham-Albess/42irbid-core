class GardenManager:
    ...
    class GardenStats:
        ...
        def plants_in_garden(plants: list) -> None:
            ...
            for i in plants:
                if i.get_type() == "prize":
                    print(f"- {i.get_name()}: {i.get_height()}cm,", end=' ')
                    print(f"{i.get_color()}", end=" ")
                    if i.get_bloom():
                        print("(blooming)", end="")
                    print(f", Prize points: {i.get_points()}")
                    ...
                    print(f"- {i.get_name()}: {i.get_height()}cm")
...
class PrizeFlower(FloweringPlant):
    ...
    def get_score(self):
        return self.get_height() + self.__points
